            ...
            <div class="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-10 items-center font-stacksans">
                ...
                <div data-aos="fade-right">
                    ...
                    <div class="mt-6 flex items-center space-x-4">
                        <a href="{{ asset('loginPage') }}" class="px-6 py-3 bg-yellow-300 text-gray-900 font-semibold rounded-lg shadow hover:bg-gray-200 transition">
                            Login Untuk Murid
                        </a>
                        <a href="{{ asset('teacher.login') }}" class="px-6 py-3 bg-transparent border border-yellow-300 text-yellow-300 font-semibold rounded-lg shadow hover:bg-yellow-300 hover:text-gray-900 transition">
                            Login Untuk Guru
                        </a>
                    </div>
                </div>
